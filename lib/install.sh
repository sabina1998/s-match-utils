...
mvn org.apache.maven.plugins:maven-install-plugin:2.5.1:install-file -Dfile=orbital/orbital-core.jar -DgroupId=orbital -DartifactId=orbital-core -Dversion=1.3.0 -Dpackaging=jar
mvn org.apache.maven.plugins:maven-install-plugin:2.5.1:install-file -Dfile=orbital/orbital-ext.jar -DgroupId=orbital -DartifactId=orbital-ext -Dversion=1.3.0 -Dpackaging=jar
